  ...
  return (
    <header className={navClass}>
      <nav className="nav-container">
        <div className="logo">
          <img
            src={import.meta.env.BASE_URL + 'src/assets/tilahun_logo.png'}
            srcSet={`${import.meta.env.BASE_URL}src/assets/tilahun_logo.png 1x, ${import.meta.env.BASE_URL}src/assets/tilahun_logo@2x.png 2x`}
